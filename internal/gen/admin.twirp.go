...
func (c *adminProtobufClient) AddPodcast(ctx context.Context, in *AddPodReq) (*AddPodRes, error) {
	ctx = ctxsetters.WithPackageName(ctx, "protos")
	ctx = ctxsetters.WithServiceName(ctx, "Admin")
	ctx = ctxsetters.WithMethodName(ctx, "AddPodcast")
	caller := c.callAddPodcast
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *AddPodReq) (*AddPodRes, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*AddPodReq)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*AddPodReq) when calling interceptor")
					}
					return c.callAddPodcast(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*AddPodRes)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*AddPodRes) when calling interceptor")
				}
...
func (c *adminProtobufClient) callAddPodcast(ctx context.Context, in *AddPodReq) (*AddPodRes, error) {
	out := new(AddPodRes)
...
func (c *adminProtobufClient) RefreshPodcast(ctx context.Context, in *RefPodReq) (*RefPodRes, error) {
	ctx = ctxsetters.WithPackageName(ctx, "protos")
	ctx = ctxsetters.WithServiceName(ctx, "Admin")
	ctx = ctxsetters.WithMethodName(ctx, "RefreshPodcast")
	caller := c.callRefreshPodcast
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *RefPodReq) (*RefPodRes, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*RefPodReq)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*RefPodReq) when calling interceptor")
					}
					return c.callRefreshPodcast(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*RefPodRes)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*RefPodRes) when calling interceptor")
				}
				return typedResp, err
			}
			return nil, err
...
func (c *adminProtobufClient) callRefreshPodcast(ctx context.Context, in *RefPodReq) (*RefPodRes, error) {
	out := new(RefPodRes)
...
func (c *adminJSONClient) AddPodcast(ctx context.Context, in *AddPodReq) (*AddPodRes, error) {
	ctx = ctxsetters.WithPackageName(ctx, "protos")
	ctx = ctxsetters.WithServiceName(ctx, "Admin")
	ctx = ctxsetters.WithMethodName(ctx, "AddPodcast")
	caller := c.callAddPodcast
...
func (c *adminJSONClient) callAddPodcast(ctx context.Context, in *AddPodReq) (*AddPodRes, error) {
	out := new(AddPodRes)
...
func (c *adminJSONClient) RefreshPodcast(ctx context.Context, in *RefPodReq) (*RefPodRes, error) {
	ctx = ctxsetters.WithPackageName(ctx, "protos")
	ctx = ctxsetters.WithServiceName(ctx, "Admin")
	ctx = ctxsetters.WithMethodName(ctx, "RefreshPodcast")
	caller := c.callRefreshPodcast
...
func (s *adminServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch method {
	case "AddPodcast":
		s.serveAddPodcast(ctx, resp, req)
		return
	case "RefreshPodcast":
...
func (s *adminServer) serveAddPodcast(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveAddPodcastJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveAddPodcastProtobuf(ctx, resp, req)
	default:
...
func (s *adminServer) serveAddPodcastJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "AddPodcast")
	...
	handler := s.Admin.AddPodcast
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *AddPodReq) (*AddPodRes, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Admin.AddPodcast(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*AddPodRes)
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *AddPodRes and nil error while calling AddPodcast. nil responses are not supported"))
		return
	}
...
func (s *adminServer) serveAddPodcastProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "AddPodcast")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *adminServer) serveRefreshPodcast(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveRefreshPodcastJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveRefreshPodcastProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *adminServer) serveRefreshPodcastJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RefreshPodcast")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	handler := s.Admin.RefreshPodcast
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *RefPodReq) (*RefPodRes, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*RefPodReq)
					if !ok {
					...
					return s.Admin.RefreshPodcast(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*RefPodRes)
...
func (s *adminServer) serveRefreshPodcastProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RefreshPodcast")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *adminServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "protos", "Admin")
}
